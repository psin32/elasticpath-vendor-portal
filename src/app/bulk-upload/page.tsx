...
export default function BulkUploadPage() {
  ...
  const handleEntityTypeChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    setUploadData(prev => ({ ...prev, entityType: event.target.value as BulkUploadData['entityType'] }));
  };
  ...
  const downloadTemplate = (entityType: string) => {
    ...
    const templateData = {
      products: "sku,name,description,price,currency\nPROD001,Sample Product,Description,1000,USD",
      orders: "order_id,customer_email,status,total\nORD001,test@example.com,pending,1000",
      customers: "email,first_name,last_name,phone\njohn@example.com,John,Doe,+1234567890"
    };
    
    const blob = new Blob([templateData[entityType as keyof typeof templateData] || ""], { type: 'text/csv' });
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={!uploadData.file || !uploadData.template || isUploading}
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">How to use Bulk Upload</h2>
          </div>
          <div className="px-6 py-6">
            <ol className="list-decimal list-inside space-y-3 text-sm text-gray-600">
              <li>Select the type of data you want to upload (Products, Orders, or Customers)</li>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-md">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                ...
                <li>• Review the template for field requirements and formats</li>
              </ul>
            </div>
          </div>
        </div>
