          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleFormChange("customerId", e.target.value || undefined)
                }
                disabled={loading}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleFormChange("contactName", e.target.value || undefined)
                }
                disabled={loading}
                placeholder="John Doe"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleFormChange("contactEmail", e.target.value || undefined)
                }
                disabled={loading}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleFormChange("productSku", e.target.value || undefined)
                }
                disabled={loading}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleFormChange("externalRef", e.target.value || undefined)
                }
                disabled={loading}
                placeholder="16be*"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("createdFrom", e.target.value || undefined)
                  }
                  disabled={loading}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
                />
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("createdTo", e.target.value || undefined)
                  }
                  disabled={loading}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
                />
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("updatedFrom", e.target.value || undefined)
                  }
                  disabled={loading}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
                />
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("updatedTo", e.target.value || undefined)
                  }
                  disabled={loading}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
                />
