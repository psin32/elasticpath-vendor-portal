...
export const sampleMappings: Omit<Mapping, "id" | "createdAt" | "updatedAt">[] =
  [
    {
      name: "Product Catalog",
      description:
        "Mapping for importing product information including SKU, name, pricing, and categories",
      entityType: "products",
      fields: [
        {
          id: "field_sku",
...
export const createSampleMapping = (
  mappingData: (typeof sampleMappings)[0]
): Mapping => {
  return {
    ...mappingData,
